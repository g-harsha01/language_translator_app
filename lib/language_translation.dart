...
class _LanguageTranslationState extends State<LanguageTranslation> {
  ...
  var languages = ['Hindi','English','French','Telugu'];
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  DropdownButton(
                    ...
                    hint: Text(
                      orignalLanguage,style: TextStyle(color: Colors.white),
                    ),
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle: TextStyle(fontSize: 15,color: Colors.lightBlueAccent),
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () {
                    translate(getLanguageCode(orignalLanguage), getLanguageCode(destinationLanguage), languageController.text.toString());
